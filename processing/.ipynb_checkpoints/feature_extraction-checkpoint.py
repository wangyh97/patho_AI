...
def main():
    ...
    with torch.no_grad():
        ...
        np.save(os.path.join(save_dir,f'{args.scale}X_full_slide_features.npy'),slide_features)
        np.save(os.path.join(save_dir,f'{args.scale}X_full_not_extracted.npy'),unextracted)

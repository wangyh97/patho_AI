...
#                                                                last_epoch=-1)
        ...
        '''
        torch.utils.TensorBoard.SummaryWritter:
            attr:log_dir:string
                saving directory location,default is runs/**CURRENT_DATATIME_HOSTNAME**,changes after each run
        demo result of line 85:
            runs/Apr04_23-59-01_ubuntu-T640/checkpoints
        '''
        # save config file
    ...
    #continue from checkpoints if exists
